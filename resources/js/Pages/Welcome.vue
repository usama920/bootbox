    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            <template v-if="$page.props.auth.user">
                ...
                <Link  :href="route('logout')" method="post" as="button" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Logout</Link>
            </template>
            <template v-else>
        ...
        <nav id="topnav" class="defaultscroll is-sticky">
            <div class="container">
                ...
                <ul class="buy-button list-none mb-0">
                    ...
                    <li class="inline-block pl-1 mb-0">
                        <a href="" class="btn btn-icon rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white">
                ...
                <div id="navigation">
                    <ul class="navigation-menu justify-end">
                        <li class="has-submenu parent-menu-item">
                            ...
                            <ul class="submenu">
                                <li><a href="#" class="sub-menu-item">Home One</a></li>
                        ...
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu">
                                <li><a href="#" class="sub-menu-item"> Explore One</a></li>
                                <li><a href="#" class="sub-menu-item"> Explore Two</a></li>
                                <li><a href="#" class="sub-menu-item"> Explore Three</a></li>
                            </ul>
                        </li>
                        <li><a href="#" class="sub-menu-item">Wallet</a></li>
                        <li class="has-submenu parent-parent-menu-item">
                            ...
                            <ul class="submenu">
                                ...
                                <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> Creator </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        <li><a href="#" class="sub-menu-item"> Creators</a></li>
                                        <li><a href="#" class="sub-menu-item"> Creator Profile</a></li>
                                        <li><a href="#" class="sub-menu-item"> Profile Edit</a></li>
                                        <li><a href="#" class="sub-menu-item"> Become Creator</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> Auth Pages </a><span class="submenu-arrow"></span>
                                    <ul class="submenu">
                                        ...
                                        <li><a href="#" class="sub-menu-item"> Forgot Password</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#" class="sub-menu-item">Terms Policy</a></li>
            ...
            <div class="container">
                <div class="grid grid-cols-1 justify-center text-center mt-10">
                    <div class="relative">
                        ...
                        <div class="mt-8">
                            <a href="#" class="btn bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-full">Explore now</a>
                        </div>
                    </div>
                </div><!--end grid-->
            ...
            <div class="container md:mt-36 mt-24">
                <div class="md:flex justify-between items-center">
                    ...
                    <div class="md:w-2/12 text-right md:block hidden">
                        <a href="#" class="btn btn-link text-[16px] font-medium hover:text-violet-600 after:bg-violet-600 duration-500 ease-in-out">See More <i class="uil uil-arrow-right"></i></a>
                    </div>
                </div><!--end grid-->
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">Digital Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@CutieGirl</a></span>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">GIF Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@ButterFly</a></span>
                                        <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">Sports Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@NorseQueen</a></span>
                                        <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">Photography Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@BigBull</a></span>
                                        <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">Illustrations Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@Angel</a></span>
                                        <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tiny-slide">
                            <div class="group relative overflow-hidden bg-white dark:bg-slate-900 rounded-lg p-3 shadow dark:shadow-gray-800 ease-in-out duration-500 m-2">
                                ...
                                <div class="relative p-4 -mt-14">
                                    ...
                                    <div class="mt-3">
                                        <a href="#" class="font-semibold block text-[18px] hover:text-violet-600">Animations Collection</a>
                                        <span class="text-slate-400 mt-1 text-sm"><span class="italic">by</span> <a href="#" class="text-violet-600 font-medium">@CrazyAnyone</a></span>
                                        <span class="text-slate-400 block text-[16px] mt-1">25 Items</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        <div class="relative overflow-hidden">
                            ...
                            <div class="absolute -bottom-20 group-hover:bottom-1/2 group-hover:translate-y-1/2 right-0 left-0 mx-auto text-center transition-all duration-500">
                                <a href="#" class="btn btn-sm rounded-full bg-violet-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white"><i class="mdi mdi-lightning-bolt"></i> Buy Now</a>
                            </div>
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@StreetBoy</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@CutieGirl</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@ButterFly</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@NorseQueen</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@BigBull</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@Angel</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@CrazyAnyone</a>
                            </div>
                    ...
                    <div class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                        ...
                        <div class="mt-3">
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ml-2 text-[15px] font-medium text-slate-400 hover:text-violet-600">@Princess</a>
                            </div>
                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-10 gap-[30px]">
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Tiffany Betancourt</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Jacqueline Burns</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Mari Harrington</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Floyd Glasgow</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Donna Schultz</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Joshua Morris</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Rosaria Vargas</a>
                    ...
                    <div class="flex justify-between items-center p-3 rounded-md bg-white dark:bg-slate-900 shadow dark:shadow-gray-800">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <a href="#" class="font-semibold block hover:text-violet-600">Carl Williams</a>
                            ...
                            <div class="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                                ...
                                <div class="lg:col-span-2 md:col-span-4">
                                    ...
                                    <ul class="list-none footer-list mt-6">
                                        <li><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Explore Item</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Live Auction</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Activities</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Wallets</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Creators</a></li>
                                    </ul>
                                </div><!--end col-->
                                ...
                                <div class="lg:col-span-3 md:col-span-4">
                                    ...
                                    <ul class="list-none footer-list mt-6">
                                        <li><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> About Us</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Blog & News</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Terms & Condition</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Privacy policy</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Login</a></li>
                                        <li class="mt-[10px]"><a href="#" class="text-[16px] text-gray-300 hover:text-gray-400 duration-500 ease-in-out"><i class="uil uil-angle-right-b me-1"></i> Contact Us</a></li>
                                    </ul>
                                </div><!--end col-->
...
<!--                                © <script>document.write(new Date().getFullYear())</script> Giglink. Design with -->
