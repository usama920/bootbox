                ...
                <div class="container">
                    <div class="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <div class="lg:col-span-5">
                            <img :src="baseUrl + '/storage/images/products/' + product_detail?.data?.image[0]?.name"
                                    ...
                                    <div v-if="!!product_detail?.data?.category" class="my-4">
                                        <div class="p-2 flex items-center"
                                            ...
                                            <input @change="showSubscribeSecond()"
                                                @click="product.subscription = data?.subscription_name?.id"
                                                :checked="product.subscription === data?.subscription_name?.id"
                                                class="text-gray-600 mr-2 focus:ring-0" name="subscription"
                                                :id="'sub' + data.subscription_types_id + 'scribe'" type="radio">
                                            <label
                                                :for="'sub' + data.subscription_types_id + 'scribe'">{{ data?.subscription_name?.name
                                                }} subscription</label>
                                        </div>
                                    </div>
                                    <div
...
<!--                                    </div>-->
                                    ...
                                    <div v-if="product.type === 0 || product.type === 1" class="mt-4">
                                        ...
                                        <div class="mx-auto md:w-1/2">
                                            <input v-model="product.address_1"
                                                class="text-white rounded flex w-full justify-center mx-auto mt-2 bg-gray-600 placeholder:text-gray-100 focus:ring-0"
                                                placeholder="Address Line 1" type="text">
                                            <span v-if="!!error.address_1"
                                                class="text-red-600 font-bold text-sm">{{ error.address_1 }}</span>
                                        </div>
                                        <div class="mx-auto md:w-1/2">
                                            <input v-model="product.address_2"
                                                class="text-white rounded flex w-full justify-center mx-auto mt-2 bg-gray-600 placeholder:text-gray-100 focus:ring-0"
                                                placeholder="Address Line 2" type="text">
                                            <span v-if="!!error.address_2"
                                                class="text-red-600 font-bold text-sm">{{ error.address_2 }}</span>
                                        </div>
                                        <div class="mx-auto md:w-1/2">
                                            <input v-model="product.city"
                                                class="text-white rounded flex w-full justify-center mx-auto mt-2 bg-gray-600 placeholder:text-gray-100 focus:ring-0"
                                                placeholder="City" type="text">
                                            <span v-if="!!error.city"
                                                class="text-red-600 font-bold text-sm">{{ error.city }}</span>
                                        </div>
                                        <div class="mx-auto md:w-1/2">
                                            <input v-model="product.state"
                                                class="text-white rounded flex w-full justify-center mx-auto mt-2 bg-gray-600 placeholder:text-gray-100 focus:ring-0"
                                                placeholder="State" type="text">
                                            <span v-if="!!error.state"
                                                class="text-red-600 font-bold text-sm">{{ error.state }}</span>
                                        </div>
                                        <div class="mx-auto md:w-1/2">
        ...
        <div class="mx-auto">
            ...
            <form @submit.prevent="submitLogin">
                ...
                <div class="mt-4 flex justify-center">
                    <div @click="signUpModal()"
                    class="text-sm pr-4 cursor-pointer text-gray-600 underline hover:text-gray-900">
                    Signup
                </div>
            </div>
            <div class="mt-6">
                <PrimaryButton class="w-full" :class="{ 'opacity-25': loginForm.processing }"
    ...
    <div class="mx-auto">
        ...
        <form @submit.prevent="submitRegister">
            ...
            <div class="mt-4 flex flex-col items-end">
                <PrimaryButton class="w-full" :class="{ 'opacity-25': registerForm.processing }"
