    ...
    <div class="font-urbanist text-base text-black dark:text-white dark:bg-slate-900">
        <UserLayout>
            ...
            <section class="relative py-16">
                <div class="container">
                    <div class="grid lg:grid-cols-12 grid-cols-2 items-start gap-[30px]">
                        <div class="lg:col-span-5">
                            <div class="relative">
                                <div class="absolute inset-0 bg-gradient-to-r from-red-600 to-violet-600 rounded-lg -mt-[15px] -ml-[15px] h-[98%] w-[98%] -z-1"></div>
                                <img v-if="!!about && !!about?.image" :src="baseUrl+'/storage/images/about/'+about?.image" class="rounded-lg shadow shadow-gray-800" alt="">
                            </div>
                        </div>
