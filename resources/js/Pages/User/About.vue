                    ...
                    <div class="grid lg:grid-cols-12 sm:grid-cols-2 items-start gap-[30px]">
                        <div class="lg:col-span-5">
                            <div class="relative">
                                ...
                                <img v-if="!!about && !!about?.image" :src="baseUrl+'/storage/images/about/'+about?.image" class="rounded-lg mx-auto shadow shadow-gray-800" alt="">
                            </div>
                        </div>
                        <div class="lg:col-span-7">
                            <div class="lg:ml-5">
                                <span class="text-violet-600 font-medium">Boot Box Vision & Mission</span>
                                <h3 class="mb-4 md:text-3xl text-2xl md:leading-snug leading-snug font-semibold">{{about?.heading}}</h3>
                                <p class="text-slate-400 max-w-xl">{{about?.description}}</p>
                                <div class="mt-6">
